...
public class POSTag {
    public static void main(String[] args) throws IOException {
        ...
        BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(rootDir + "\\resources\\english\\Laptops_English_Train_Without_Duplicates_2016.txt"), "UTF-8"));
