 ...
 */
public class ABSAPolarityHotels {

    String rootDirectory;
    LinkedHashMap<String, Integer> polarity;

    ABSAPolarityHotels(int option, String trainFileName, String testFileName, String pairFile) throws IOException {
    ...
    private void getIdentityWords() throws IOException {
        ...
        PrintWriter tfIdfFile = new PrintWriter(new BufferedWriter(new FileWriter(rootDirectory+"\\resources\\tfIdf\\Hotels_English.txt")));
        ...
        Writer writer = new OutputStreamWriter(new FileOutputStream(rootDirectory + "\\resources\\tfIdf\\Hotels_EnglishDT.txt"), "UTF-8");
