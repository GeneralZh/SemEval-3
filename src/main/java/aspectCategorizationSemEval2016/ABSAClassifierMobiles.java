...
public class ABSAClassifierMobiles {
    static String rootDirectory;
    static List<LinkedHashMap<Integer, Double>> trainingFeature;
    static List<LinkedHashMap<Integer, Double>> testFeature;


    ABSAClassifierMobiles(int option, String trainFile, String testFile, String ddgFile) throws IOException {
    ...
    private int generateFeature(int option, String trainFile, String testFile, String ddgFile) throws IOException {
        ...
        //generateDataset(rootDirectory + "\\dataset\\dataset_sentimentClassification\\"+trainFile, rootDirectory + "\\dataset\\dataset_sentimentClassification\\Train_Mobiles_Contextual_Cleansed.txt");


        //TRAINING SET//
        ABSAClassifierHelperM trainingObject = new ABSAClassifierHelperM(rootDirectory + "\\dataset\\dataset_aspectCategorization\\" + trainFile);

        //TESTING SET
        ABSAClassifierHelperM testObject = null;
        if (option == 2 || option == 3) {
            //generateDataset(rootDirectory + "\\dataset\\dataset_sentimentClassification\\"+testFile, rootDirectory + "\\dataset\\dataset_sentimentClassification\\Test_Mobiles_Contextual_Cleansed.txt");
            testObject = new ABSAClassifierHelperM(rootDirectory + "\\dataset\\dataset_aspectCategorization\\" + testFile);
        }
        //TRAINING SET
        /*ABSAABSAClassifierHelperMR trainingObject = new ABSAABSAClassifierHelperMR(rootDirectory + "\\dataset\\dataset_aspectCategorization\\Mobiles_Train_ABSA.txt");


        //TESTING SET
        ABSAABSAClassifierHelperMR testObject = new ABSAABSAClassifierHelperMR(rootDirectory + "\\dataset\\dataset_aspectCategorization\\Mobiles_Test_ABSA.txt");
*/
        //POS FEATURE
        int start = 0;
        ...
        int finalSize = start + tfDTObject.getFeatureCount();
    ...
    private void mainClassifierFunction(int option, String trainFile, String testFile, String ddgFile) throws IOException {
        ...
        PrintWriter write = new PrintWriter(new BufferedWriter(new FileWriter(rootDirectory + "\\dataset\\dataset_aspectCategorization\\predictedMobilesLabels.txt")));
