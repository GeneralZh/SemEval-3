...
class ABSAClassifierHelperH {
    ...
    public class ABSAClassifierHotels {
    static String rootDirectory;
    static List<LinkedHashMap<Integer, Double>> trainingFeature;
    static List<LinkedHashMap<Integer, Double>> testFeature;


    ABSAClassifierHotels(int option, String trainFile, String testFile, String ddgFile) throws IOException {
    ...
    private int generateFeature(int option, String trainFile, String testFile, String ddgFile) throws IOException {
        ...
        //TRAINING SET//
        ABSAClassifierHelperH trainingObject = new ABSAClassifierHelperH(rootDirectory + "\\dataset\\dataset_aspectCategorization\\" + trainFile);

        //TESTING SET
        ABSAClassifierHelperH testObject = null;
        if (option == 2 || option == 3) {
            ...
            testObject = new ABSAClassifierHelperH(rootDirectory + "\\dataset\\dataset_aspectCategorization\\" + testFile);
        }
        //TRAINING SET
        /*ABSAABSAClassifierHelperHR trainingObject = new ABSAABSAClassifierHelperHR(rootDirectory + "\\dataset\\dataset_aspectCategorization\\Hotels_Train_ABSA.txt");


        //TESTING SET
        ABSAABSAClassifierHelperHR testObject = new ABSAABSAClassifierHelperHR(rootDirectory + "\\dataset\\dataset_aspectCategorization\\Hotels_Test_ABSA.txt");
*/
        //POS FEATURE
        int start = 0;
    ...
    private void mainClassifierFunction(int option, String trainFile, String testFile, String ddgFile) throws IOException {
        ...
        PrintWriter write = new PrintWriter(new BufferedWriter(new FileWriter(rootDirectory + "\\dataset\\dataset_aspectCategorization\\predictedHotelsLabels.txt")));
