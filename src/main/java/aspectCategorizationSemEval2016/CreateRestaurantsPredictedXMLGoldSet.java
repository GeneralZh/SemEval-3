 ...
 */
public class CreateRestaurantsPredictedXMLGoldSet {
    String rootDirectory;

    CreateRestaurantsPredictedXMLGoldSet() throws IOException {
        ...
        create(root, "\\predictedRestaurantsLabels.txt", "\\XML Files\\Restaurants_French_Train.xml", "\\Scorer\\pred.xml");
    }
    ...
    public static void main(String[] args) throws IOException {
        CreateRestaurantsPredictedXMLGoldSet ob = new CreateRestaurantsPredictedXMLGoldSet();
    }
}
