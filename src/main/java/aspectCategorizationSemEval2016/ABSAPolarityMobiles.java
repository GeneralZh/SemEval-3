 ...
 */
public class ABSAPolarityMobiles {

    String rootDirectory;
    LinkedHashMap<String, Integer> polarity;

    ABSAPolarityMobiles(int option, String trainFileName, String testFileName, String pairFile) throws IOException {
        ...
        try {
            ...
            while ((line = read.readLine()) != null) {
                ...
                if (!polarity.containsKey(words[4])) {
                    ...
                    System.out.println(polarity.get(words[4]));
    ...
    private void getIdentityWords() throws IOException {
        ...
        PrintWriter tfIdfFile = new PrintWriter(new BufferedWriter(new FileWriter(rootDirectory+"\\resources\\tfIdf\\Mobiles_English.txt")));
        ...
        Writer writer = new OutputStreamWriter(new FileOutputStream(rootDirectory + "\\resources\\tfIdf\\Mobiles_EnglishDT.txt"), "UTF-8");
        ...
        for (int i = 0; i < wordMap.size(); i++)    //Print the feature values in sorted order
        {
            ...
            while (iterator.hasNext() && counter<=5) {
                ...
                if(mentry.getValue().toString().compareToIgnoreCase("-0.0") != 0){
                    ...
                    URL oracle = new URL("http://maggie.lt.informatik.tu-darmstadt.de:10080/jobim/ws/api/dutchTrigram/jo/similar/" + mentry.getKey() + "?numberOfEntries=10&format=tsv");
