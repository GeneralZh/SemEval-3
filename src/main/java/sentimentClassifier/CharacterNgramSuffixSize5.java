 ...
 */
public class CharacterNgramSuffixSize5 {
    ...
    CharacterNgramSuffixSize5(String rootDirectory) throws IOException {
    ...
    private LinkedHashMap<String, Integer> generateCharacterNgrams() throws IOException {
        ...
        for (int i = 0; i < words.length; i++) {
            ...
            String ngram;
            if (words[i].length() >= 5) {
                ngram = words[i].substring(words[i].length() - 5);
    ...
    public static void main(String[] args) throws IOException {
        CharacterNgramSuffixSize5 ob = new CharacterNgramSuffixSize5(System.getProperty("user.dir"));
    }
}
