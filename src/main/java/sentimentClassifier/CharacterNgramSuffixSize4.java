 ...
 */
public class CharacterNgramSuffixSize4 {
    ...
    CharacterNgramSuffixSize4(String rootDirectory) throws IOException {
    ...
    private LinkedHashMap<String, Integer> generateCharacterNgrams() throws IOException {
        ...
        for (int i = 0; i < words.length; i++) {
            ...
            String ngram;
            if (words[i].length() >= 4) {
                ngram = words[i].substring(words[i].length() - 4);
    ...
    public static void main(String[] args) throws IOException {
        CharacterNgramSuffixSize4 ob = new CharacterNgramSuffixSize4(System.getProperty("user.dir"));
    }
}
