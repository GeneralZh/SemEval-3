 ...
 */
public class CharacterNgramSuffixSize3 {
    ...
    CharacterNgramSuffixSize3(String rootDirectory) throws IOException {
    ...
    private LinkedHashMap<String, Integer> generateCharacterNgrams() throws IOException {
        ...
        for (int i = 0; i < words.length; i++) {
            ...
            String ngram;
            if (words[i].length() >= 3) {
                ngram = words[i].substring(words[i].length() - 3);
    ...
    private List<LinkedHashMap<Integer, Double>> generateFeature(LinkedHashMap<String, Integer> indexedNgram, String fileName) throws IOException {
        ...
        try {
            ...
            while ((line = read.readLine()) != null) {
                ...
                /*PrintWriter write = new PrintWriter(new BufferedWriter(new FileWriter("E:\\COURSE\\Semester VII\\Internship\\aspectCategorizationSemEval2016\\dataset\\ngram_Train" + n + ".txt")));
    ...
    public static void main(String[] args) throws IOException {
        CharacterNgramSuffixSize3 ob = new CharacterNgramSuffixSize3(System.getProperty("user.dir"));
    }
}
