...
public class SentimentClassifierM {
    ...
    SentimentClassifierM(int option, String trainFile, String testFile) throws IOException {
    ...
    private int generateFeature(int option, String trainFile, String testFile) throws IOException {
        ...
        //TRAINING SET
        ClassifierHelperM trainingObject = new ClassifierHelperM(rootDirectory + "\\dataset\\dataset_sentimentClassification\\Train_Contextual_Cleansed.txt");

        //TESTING SET
        ClassifierHelperM testObject = null;
        if(option == 2 || option == 3)
        {
            ...
            testObject = new ClassifierHelperM(rootDirectory + "\\dataset\\dataset_sentimentClassification\\Test_Contextual_Cleansed.txt");
        }
        ...
        //ENTITY FEATURE
        start += ngramObject.getFeatureCount();
        EntityFeatureMobiles entityObject = new EntityFeatureMobiles(rootDirectory, trainFile, testFile);
    ...
    private void mainClassifierFunction(int option, String trainFile, String testFile)throws IOException {
        ...
        double C = 0.9;    // cost of constraints violation
