 ...
 */
public class GetDTTopWordsPolarityDutch {

    String rootDirectory;
    GetDTTopWordsPolarityDutch()throws IOException
    {
    ...
    private void mainFunction(String rootDirectory)throws IOException
    {
        ...
        File fR = new File(rootDirectory+"\\resources\\DTExpansion\\DTPolarity\\valuesDT.txt");
        ...
        Writer polWriter1 = new OutputStreamWriter(
                new FileOutputStream(rootDirectory+"\\resources\\DTExpansion\\DTPolarity\\sortedDT.txt"), "UTF-8");
        ...
        Writer polWriter = new OutputStreamWriter(
                new FileOutputStream(rootDirectory+"\\resources\\DTExpansion\\DTPolarity\\polarityValuesAll.txt"), "UTF-8");
